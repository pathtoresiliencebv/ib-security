          ...
          <div className="text-center mb-16 animate-on-scroll">
            ...
            <h2 className="font-heading text-3xl md:text-5xl font-black text-gray-900 mb-6">
              ...
              <span className="block text-green-600">
                Mobiele Surveillance Offerte Op
              </span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      id="quote-name"
                      required
                      className="border-2 border-gray-200 focus:border-green-500 text-lg py-3"
                ...
                <div>
                  <Label
                    ...
                    className="text-sm font-bold text-gray-700 mb-2 block"
                  >
                    Uw Mobiele Surveillance Wensen *
                  </Label>
                  <Textarea
                    id="quote-message"
                    required
                    className="border-2 border-gray-200 focus:border-green-500 text-lg min-h-32"
                    placeholder="Beschrijf uw mobiele surveillance behoeften: locaties, gewenste rondes, specifieke eisen..."
                  />
                </div>
                ...
                <div className="text-center pt-6">
                  <Button
                    type="submit"
                    size="lg"
                    className="relative bg-gradient-to-r from-green-600 via-blue-600 to-green-800 hover:from-green-700 hover:via-blue-700 hover:to-green-900 text-white shadow-4xl text-xl px-12 py-6 font-black transform hover:scale-105 transition-all duration-300 overflow-hidden group"
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-green-600 to-blue-800 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="relative z-10 flex items-center">
                      <Calculator className="mr-3 h-6 w-6" />
                      GRATIS SURVEILLANCE OFFERTE
                    </div>
                  </Button>
