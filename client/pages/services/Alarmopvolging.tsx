      ...
      <section className="py-32 bg-gradient-to-br from-slate-50 via-yellow-50/30 to-orange-50/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-on-scroll">
            <Badge className="mb-6 bg-yellow-600 text-white px-6 py-3 text-lg font-bold">
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      id="quote-name"
                      required
                      className="border-2 border-gray-200 focus:border-yellow-500 text-lg py-3"
                ...
                <div>
                  <Label
                    ...
                    className="text-sm font-bold text-gray-700 mb-2 block"
                  >
                    Uw Alarmopvolging Wensen *
                  </Label>
                  <Textarea
                    id="quote-message"
                    required
                    className="border-2 border-gray-200 focus:border-yellow-500 text-lg min-h-32"
                    placeholder="Beschrijf uw alarmopvolging behoeften: locatie, type alarmsysteem, gewenste responstijd..."
                  />
                </div>
                ...
                <div className="text-center pt-6">
                  <Button
                    type="submit"
                    size="lg"
                    className="relative bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 text-white shadow-4xl text-xl px-12 py-6 font-black transform hover:scale-105 transition-all duration-300 overflow-hidden group"
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-orange-600 via-yellow-600 to-orange-800 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="relative z-10 flex items-center">
                      <Calculator className="mr-3 h-6 w-6" />
                      GRATIS ALARMOPVOLGING OFFERTE
                    </div>
                  </Button>
